...
class VaIcon extends HTMLElement 
{
    ...
    constructor()
    {
        ...
        this.dom.querySelector("ui-button-group").addEventListener("down", async (event) =>
        {
    ...
    attributeChangedCallback(name, oldValue, newValue)
    {
        if (name == "icon")
        {
            this.dom.querySelector("ui-button-group").press(this.dom.querySelector(`#${newValue}`), false);
        }
    }
