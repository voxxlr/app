    ...
    constructor()
    {
        ...
        this.dom.innerHTML = `
            ...
            <style>
                ...
                :host-context(ui-collapsible[selected]) ui-button-group { visibility: visible; }
            ...
            <div>
                <ui-button-group id="line-mode" multi>
        ...
        this.dom.querySelectorAll("ui-button-group").forEach(group =>  
        {
