    ...
    constructor() 
    {
        ...
        this.dom.innerHTML = `
            ...
            <style>
                ...
                ui-popup ui-button-group { margin-bottom: 0.5em }
            ...
            <ui-popup id="menu" hidden>
                <ui-button-group class="vx-bar" single required>
        ...
        this.list.addEventListener("item-select", event =>
        {
        ...
        this.level = this.dom.querySelector("ui-button-group")
        ...
        {
            let group = this.popup.querySelector("ui-button-group");
            group.press(group.querySelector(`button[name='${event.detail.record.status}']`));
...
class IssueForm extends HTMLElement 
{
    ...
    constructor() 
    {
        ...
        this.dom.innerHTML = `
            ...
            <style>
                ...
                ui-panel.row { display: flex; flex-direction: row; }
                
                #assignment { display: flex; }
                
                ui-dropdown-select:not(:first-child)
                {
                    margin-top: 1.0em;
                }
                ...
                ui-button-group { margin-top: 0.5em }
                ui-button-group  i { font-size: 1.5em }
            ...
            <main>
                <div>
                    ...
                    <ui-panel id="assignment" class="column" name="assignment" required>
                        <ui-dropdown-select>
                            <ui-option value="1">Contractor</ui-option>
                            <ui-option value="2" selected>Inspector</ui-option>
                            <ui-option value="3">Engineer</ui-option>
                        </ui-dropdown-select>
                        <ui-button-group class="vx-bar" single>
        ...
        this.assignee = this.dom.querySelector("ui-dropdown-select")
    }
    ...
    connectedCallback() 
    {
        this.dom.getElementById("createIssue").addEventListener("click", async (event) =>
        {
            ...
            let issue = 
            {
                ...
                assignee: this.assignee.getAttribute("value"),
            };
    ...
    validate()
    {
        let valid = this.question.value != "" && this.assignee.hasAttribute("value") && this.subject.value != "";
