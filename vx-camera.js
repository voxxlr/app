...
class VxCamera extends HTMLElement 
{
    constructor()   
    {
        super();
        ...
        `;		
        this.cameraButtons = this.dom.querySelector(':host > ui-button-group');
        this.cameraButtons.addEventListener("down", event => 
        {
            ...
            if (button.id === "explore")
            {
                ...
                this.viewer.post("controller", { name: this.exploreButtons.querySelector('button[active]').id });
            ...
            //this.viewer.post("controller", { name: event.detail.id });	
        })
        
        this.exploreButtons = this.dom.querySelector('.panel ui-button-group');
        ...
        this.viewer.on("viewer.load", async args =>
        {
            if (args.type == "cloud" || args.type == "model")
            {
                ...
                viewer.on("controller", (args)=>
                {
                    ...
                    {
                        this.cameraButtons.press(this.dom.getElementById("explore"));
                        this.exploreButtons.press(this.dom.getElementById(args.name));
                    ...
                    {
                        this.cameraButtons.press(this.dom.getElementById("inspect"));
                ...
                viewer.on(["model.dblclick", "cloud.dblclick"], (event)=>
                {
                    if (event.id)
                    {
...
customElements.define("vx-camera", VxCamera);
